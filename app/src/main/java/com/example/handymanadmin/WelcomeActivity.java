    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnhandyman.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(WelcomeActivity.this, HandymanRegister.class));
...
btnhandyman.setEnabled(false);
makeToast("You can not register without .Please turn gps on");
